...
namespace LB4
{
    namespace Factories
    {
        ...
        {
            Rose CreateRose(String color, int price);
            Tulpin CreateTulpin(String color, int price);
            Iris CreateIris(String color, int price);
            Gladiolus CreateGladiolus(String color, int price);
        ...
        {
            Wrapper CreateWrapper(String material, int price);
        }
        ...
        {
            IObjectPrinter CreateObjectPrinter(PrinterType type); 
        }
